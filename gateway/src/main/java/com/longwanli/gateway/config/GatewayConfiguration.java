package com.longwanli.gateway.config;
...
public class GatewayConfiguration {
    ...
    public void initGatewayRules() {
        ...
        //配置路由id为provider_route的路由限流规则为：每秒最多访问1次
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api1 = new ApiDefinition("provider_api1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem().setPattern("/provider/providerController/api1/**")
                            .setMatchStrategy(SentinelGatewayConstants.URL_MATCH_STRATEGY_PREFIX));
                }});
        //设置分组的路由映射的请求
        ApiDefinition api2 = new ApiDefinition("provider_api2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem().setPattern("/provider/providerController/api2/demo1"));
                }});
